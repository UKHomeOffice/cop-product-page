      ...
      <div className="govuk-header__container govuk-width-container">
        <div className="govuk-header__logo">
          ...
          >
            ...
            <span
              id="service-name"
              className="govuk-header__product-name service-name"
            />
        ...
        <div className="govuk-header__content">
          <button
            ...
            onClick={() => showMobileButton()}
            onKeyPress={() => showMobileButton()}
          >
            Menu
          </button>
          <nav>
                ...
                if (value.name === "Sign-in") {
                  ...
                  return (
                    <li className="govuk-header__navigation-item" key={index}>
                      <Link
                        to={value.href}
                        getProps={isAboutPartiallyActive}
                  ...
                  return (
                    <li className="govuk-header__navigation-item" key={index}>
                      <Link
                        to={value.href}
                        getProps={isHelpPartiallyActive}
                        className="govuk-header__link header-nav-items"
                      >
                        {value.name}
                      </Link>
