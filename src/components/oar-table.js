        ...
        <div>
            {props.table.map((value, index) => {
                return <div key={index} style={{marginBottom: '2px'}} className="govuk-grid-row displayFlexOnDesktop">
                    <div className="govuk-grid-column-one-third" style={{backgroundColor: '#00703c'}}>
                    ...
                    <div style={{backgroundColor: 'rgba(0, 112, 60, 0.2)'}} className="govuk-grid-column-two-thirds">
