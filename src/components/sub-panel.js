      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          <p style={panelContentAdditionalStyleOverrides} className="govuk-body-m"><span className="govuk-!-font-weight-bold">Mandatory Declarations (Man Dec)</span> submission deadline is <span className="govuk-!-font-weight-bold">30 April 2020</span><br/>
            <a className="govuk-link govuk-!-font-weight-bold" href="https://www.cop.homeoffice.gov.uk/">Sign-in</a> to COP to fill in the form, or <a className="govuk-link govuk-!-font-weight-bold" href="https://training.cop.homeoffice.gov.uk/mandec.html#mandatory-declarations-man-dec">find out more about the Man Dec.</a></p>
        </div>
      </div>
    </div>
  </div>
