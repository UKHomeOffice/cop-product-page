    ...
    <div className="govuk-width-container">
      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          <p style={{marginBottom: '0px'}} className="govuk-body-m"><span className="govuk-!-font-weight-bold">Mandatory Declarations (Man Dec)</span> submission deadline is <span className="govuk-!-font-weight-bold">31 March 2020</span><br/>
