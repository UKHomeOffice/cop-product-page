        ...
        <div>
            {props.table.map((value, index) => {
                return <div key={index} className="govuk-grid-row displayFlexOnDesktop">
                    <div className="govuk-grid-column-one-third minimalStandardsTable" style={{backgroundColor: '#00703c', margin: '1px'}}>
                    ...
                    <div style={{backgroundColor: 'rgba(0, 112, 60, 0.2)', margin: '1px'}} className="govuk-grid-column-one-third minimalStandardsTable">
                    ...
                    <div style={{backgroundColor: 'rgba(0, 112, 60, 0.2)', margin: '1px'}} className="govuk-grid-column-one-third ">
