      ...
      <div className="govuk-width-container">
        ...
        <div className="govuk-grid-row homepage-content-margin">
          <div className="govuk-grid-column-one-half">
            ...
            <p className="govuk-body">Find out <Link className="govuk-link" to="/help/">how to use COP</Link> and its services, or <Link
              className="govuk-link" to="/help/contact/">check the contact section</Link> if you need any other help or
              assistance.
            </p>
          </div>
        </div>
